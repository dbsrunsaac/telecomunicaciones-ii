...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\linewidth]{media/demod-SNR-0db}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\linewidth]{media/demod-SNR-20db}
